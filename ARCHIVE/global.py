...
#modele entrainener par default
#model = YOLO("yolov8n.pt")

# modele entrainner
model = YOLO(r"C:\Users\maxim\Desktop\yolov8\runs\detect\train10\weights\last.pt")

# accepts all formats - image/dir/Path/URL/video/PIL/ndarray. 0 for webcam
results = model.predict(source=r"C:\Users\maxim\Desktop\yolov8\echecs_test.jpg",  show=True)
...
results = model.predict(image_np, conf=1)
boxes_data = results[0].boxes.data.cpu()  # Déplacer les boîtes sur le CPU
